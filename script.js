...
homeSection.style.transition = 'opacity 1s ease, trnasform 1s ease';
...
if (rect.top <= windowHeight * 0.75 && rect.bottom >= 0) {
    ...
    window.removeEventListener("scroll", checkAboutVisibility); // Remove o lostener após a animação
    }
}
